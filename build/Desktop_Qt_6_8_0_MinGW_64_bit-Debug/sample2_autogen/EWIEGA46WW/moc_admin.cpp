...
constexpr auto qt_meta_stringdata_CLASSadminENDCLASS = QtMocHelpers::stringData(
    "admin",
    "on_search_restaurant_clicked",
    "",
    "checked",
    "on_bussiness_list_clicked"
);
...
Q_CONSTINIT const QMetaObject admin::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSadminENDCLASS_t,
        ...
        // method 'on_search_restaurant_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<bool, std::false_type>,
        // method 'on_bussiness_list_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void admin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->on_search_restaurant_clicked((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 1: _t->on_bussiness_list_clicked(); break;
        default: ;
        }
    }
}
