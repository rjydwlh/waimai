...
struct qt_meta_stringdata_CLASSinfo_restaurantENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSinfo_restaurantENDCLASS = QtMocHelpers::stringData(
    "info_restaurant"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSinfo_restaurantENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject info_restaurant::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSinfo_restaurantENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSinfo_restaurantENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSinfo_restaurantENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *info_restaurant::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSinfo_restaurantENDCLASS.stringdata0))
