...
struct qt_meta_stringdata_CLASSsearch_restaurantENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSsearch_restaurantENDCLASS = QtMocHelpers::stringData(
    "search_restaurant",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSsearch_restaurantENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject search_restaurant::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSsearch_restaurantENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSsearch_restaurantENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSsearch_restaurantENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *search_restaurant::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSsearch_restaurantENDCLASS.stringdata0))
